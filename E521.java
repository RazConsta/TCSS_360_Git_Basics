package tools.Elliptic_Curve;
import java.math.BigInteger;

/**
 * E521 Elliptic Curve (Edward's Curve) of equation: (x^2) + (y^2) = 1 + d(x^2)(y^2)
 * where d = -376014
 * Contains methods to add (and subtract), multiply, and "divide" points on curve using scalar values.
 *
 * @version Spring 2021
 * @author Dustin Ray
 */
public class E521 {
    ...
    /** number of points on E521 Curve -> n := 4 * (R) .*/
     ...
     *
     * @param theOther E521 point to be compared against this object.
     ...
     *
     * @return E521 point which is opposite of a given point as defined above.
     */
    ...
    /**
     * Adds two E521 points and returns another (X, Y) point which is on the E521 curve defined
     ...
     * @return E521 point which is the result of the addition operation defined here. Will
     * fail with exception if point is not on curve defined in class fields.
     */
    public E521 add(final E521 theOther) {

//        System.out.println("Add: \n" + theOther.toString());
        //test for G + (-G), then return neutral point. -G := (x, p - y)
     ...
     * @param theS is the secret key to multiply by.
     * @param P is the point to multiply.
     * @return sP which is the product of s * P
     */
    ...
    /**
     * Double and add multiplication for E521 point, index decreasing.
     * @param theS Scalar value to multiply by
     * @return E521 point which is product of multiplication
     * with S.
     */
...
//            System.out.println(idx);
     ...
     * @return E521 point which is result of multiplication.
     */
